...
const skills = {
  frontend: [
    ...
    { name: "UI Libraries (ShadCN)", level: 75 },
  ],
  backend: [
  ...
  tools: [
    ...
    { name: "Jira", level: 78 },
    { name: "UML", level: 80 },
    { name: "REST/GraphQL APIs & MVC", level: 78 },
    { name: "AWS", level: 50 },
    { name: "Docker", level: 45 },
  ],
  softSkills: [
    { name: "Fast Learning & Understanding", level: 88 },
    { name: "Problem-Solving Mindset", level: 85 },
    { name: "Team Collaboration", level: 85 },
    { name: "Leadership & Influence", level: 75 },
    { name: "Interpersonal Skills", level: 78 },
    { name: "Time & Task Management", level: 80 },
    { name: "Professionalism & Reliability", level: 88 },
    { name: "Adaptability & Continuous Learning", level: 85 },
    { name: "Stress Management", level: 75 },
  ],
};
