...
const skillsData = {
  frontend: {
    ...
    skills: [
      { name: "HTML, CSS, JavaScript", level: 85, years: 2, projects: "+20" },
      { name: "SSR", level: 75, years: 2, projects: "+10" },
      { name: "React", level: 65, years: "+1", projects: "+5" },
      { name: "TypeScript", level: 70, years: 1, projects: "+5" },
      { name: "UI Libraries (ShadCN/UI)", level: 75, years: 1, projects: "2" },
    ],
    notes: "Don't let the fact that my primary focus is backend and full-stack logic fool you — I maintain a working proficiency in frontend technologies like React, Server-Side Rendering, UI libraries (ShadCN/UI), and more. I aim to strengthen my frontend expertise in the coming months and years by exploring modern frontend-focused technologies like Next.js and improving component design and interactivity.",
  },
  backend: {
  ...
  devops: {
    ...
    skills: [
      { name: "AWS", level: 50, years: 1, projects: "+3" },
      { name: "Vercel", level: 78, years: 2, projects: "+15" },
      { name: "Docker", level: 45, years: 1, projects: "+2" },
    ],
    notes: "I have some experience in deploying and managing cloud infrastructure using AWS services like S3, EC2, and VPC to handle storage, hosting, and networking efficiently. I find it very interesting, and with time I'm willing to learn it to the engineering level.",
  },
  tools: {
    ...
    skills: [
      { name: "Git / GitHub", level: 80, years: 2, projects: "+20" },
      { name: "Jira", level: 78, years: 1, projects: "+10" },
      { name: "UML", level: 80, years: 2, projects: "+15" },
      { name: "REST/GraphQL APIs & MVC", level: 78, years: 2, projects: "+15" },
      { name: "Problem-Solving & Debugging", level: 85, years: 2, projects: "+20" },
      { name: "AI-Driven Development", level: 70, years: 1, projects: "+10" },
    ],
    notes: "I see a lot of new learners saying 'you don't have to do that' or 'that's not necessary to learn,' but I say that professional development tools and best practices — centered around clean code, efficient workflows, version control, and automation — are all aimed at improving productivity and long-term project quality. That's why with every new technology or project, I try to learn and use them as much as possible.",
  },
  learning: {
    ...
    skills: [
      { name: "Next.js", level: 40, years: 0, projects: "2" },
      { name: "Advanced TypeScript", level: 55, years: 1, projects: "5" },
      { name: "Docker & CI/CD", level: 35, years: 0, projects: "3" },
      { name: "AI Tools & Integration", level: 45, years: 0, projects: "4" },
    ],
    notes: "As a web developer, you're never done learning — even after you retire. With that said, I'm currently focusing on refining my backend and DevOps skills — exploring Docker, AWS, and CI/CD — while diving deeper into TypeScript and preparing to learn Next.js. I'm also experimenting with AI tools to bring smarter, data-driven functionality into my future projects.",
  },
  softSkills: {
    title: "Soft Skills",
    icon: "🤝",
    ...
    skills: [
      { name: "Fast Learning & Understanding", level: 88, years: 2, projects: "Lifelong" },
      { name: "Problem-Solving Mindset", level: 85, years: 2, projects: "Lifelong" },
      { name: "Team Collaboration", level: 85, years: 2, projects: "+10" },
      { name: "Leadership & Influence", level: 75, years: 2, projects: "Lifelong" },
      { name: "Interpersonal Skills", level: 78, years: 2, projects: "Lifelong" },
      { name: "Time & Task Management", level: 80, years: 2, projects: "Lifelong" },
      { name: "Professionalism & Reliability", level: 88, years: 2, projects: "Lifelong" },
      { name: "Adaptability & Continuous Learning", level: 85, years: 2, projects: "Lifelong" },
      { name: "Stress Management", level: 75, years: 2, projects: "Lifelong" },
    ],
